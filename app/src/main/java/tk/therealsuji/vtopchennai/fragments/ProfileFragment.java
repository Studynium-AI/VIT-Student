    ...
    private final ItemData[] applicationProfileItems = {
            new ItemData(
                    ...
                    context -> {
                        ...
                        activeHoursSwitch.setChecked(tk.therealsuji.vtopchennai.lockscreen.ScheduleHelper.isScheduleEnabled(context));
                        activeHoursSettings.setVisibility(activeHoursSwitch.isChecked() ? View.VISIBLE : View.GONE);

                        final int[] startH = {tk.therealsuji.vtopchennai.lockscreen.ScheduleHelper.getStartHour(context)};
                        final int[] startM = {tk.therealsuji.vtopchennai.lockscreen.ScheduleHelper.getStartMinute(context)};
                        final int[] endH = {tk.therealsuji.vtopchennai.lockscreen.ScheduleHelper.getEndHour(context)};
                        final int[] endM = {tk.therealsuji.vtopchennai.lockscreen.ScheduleHelper.getEndMinute(context)};
                        ...
                        lockSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
                            if (isChecked) {
                                ...
                                tk.therealsuji.vtopchennai.lockscreen.ScheduleHelper.cancelAlarms(context);
                                Intent serviceIntent = new Intent(context, tk.therealsuji.vtopchennai.lockscreen.LockScreenService.class);
                        ...
                        activeHoursSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
                            ...
                            tk.therealsuji.vtopchennai.lockscreen.ScheduleHelper.saveSchedule(context, isChecked, startH[0], startM[0], endH[0], endM[0]);
                        ...
                        view.findViewById(R.id.btn_select_start_time).setOnClickListener(v -> {
                            new android.app.TimePickerDialog(context, (tpView, hourOfDay, minute) -> {
                                ...
                                startM[0] = minute;
                                updateTimeTexts.run();
                                tk.therealsuji.vtopchennai.lockscreen.ScheduleHelper.saveSchedule(context, activeHoursSwitch.isChecked(), startH[0], startM[0], endH[0], endM[0]);
                    ...
                    context -> {
                        ...
                        new MaterialAlertDialogBuilder(context)
                                ...
                                .setItems(days, (dialog, which) -> {
                                    ...
                                    Intent lockIntent = new Intent(context, tk.therealsuji.vtopchennai.lockscreen.LockScreenActivity.class);
            ...
            new ItemData(
                    ...
                    context -> {
                        Intent intent = new Intent(context, tk.therealsuji.vtopchennai.activities.PermissionsActivity.class);
                        context.startActivity(intent);
                    }
            ),
            new ItemData(
