...
public class TaskNotificationReceiver extends BroadcastReceiver {
    ...
    public static final String ACTION_TASK_REMINDER = "tk.therealsuji.vtopchennai.ACTION_TASK_REMINDER";
    public static final String ACTION_TASK_COMPLETE = "tk.therealsuji.vtopchennai.ACTION_TASK_COMPLETE";
