...
import app.naevis.vitstudent.fragments.TasksFragment;
import app.naevis.vitstudent.fragments.HomeFragment;
import app.naevis.vitstudent.fragments.PerformanceFragment;
import app.naevis.vitstudent.fragments.ProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    static final String TASKS_FRAGMENT_TAG = "TASKS_FRAGMENT_TAG";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        java.io.File crashLogFile = new java.io.File(getExternalFilesDir(null), "crash.log");
        if (crashLogFile.exists()) {
            try {
                java.io.BufferedReader reader = new java.io.BufferedReader(new java.io.FileReader(crashLogFile));
                ...
                new MaterialAlertDialogBuilder(this)
                        .setTitle("LockScreen UI Error Log")
        ...
        this.bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            if (item.getItemId() == R.id.item_performance) {
                ...
                selectedFragmentTag = TASKS_FRAGMENT_TAG;
                selectedFragment = getSupportFragmentManager().findFragmentByTag(selectedFragmentTag);
